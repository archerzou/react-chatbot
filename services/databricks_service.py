...
def sql_query_with_user_token(query: str, user_token: str) -> List[Dict[str, Any]]:
    ...
    This uses user authorization as per Databricks Apps documentation.
    ...
    logger.info(f"Connecting to Databricks with user token: {server_hostname}, warehouse: {DATABRICKS_WAREHOUSE_ID}")
